        ...
        @if (Auth()->user()->twoStepsEnable() == false)
            ...
            <div class="card col-span-1 row-span-3 shadow-lg xl:col-span-2 bg-base-100">
                <div class="card-body">
                    ...
                    <x-MasterStore::form.form action="{{ route('MasterStore.2fa.enable') }}">
                        <div class="px-5 py-7">
                            <x-MasterStore::form.text name="code" label="Type the code here, if successfully 2 steps will be enabled" />
                            <x-MasterStore::form.submit name="Check Code" />
                        </div>
