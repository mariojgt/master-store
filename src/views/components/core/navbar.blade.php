<div class="navbar mb-2 shadow-lg bg-neutral text-neutral-content">
    <div class="flex">
        ...
        <label for="nav-drawer" class="btn btn-square btn-ghost">
            ...
            <div class="hidden px-2 mx-2 lg:flex">
                <x-MasterStore::core.logo width="50" height="50" />
            </div>
        </label>
    </div>
    <div class="flex-1 hidden px-2 mx-2 lg:flex">
        <span class="text-lg font-bold">
            {{ config('MasterStore.version') }}
        </span>
    </div>
    ...
    <div class="flex-none">
        <div class="dropdown dropdown-end">
            ...
            <div class="shadow menu dropdown-content bg-base-100 rounded-box w-96">
    ...
    <div class="flex-none">
        <div class="dropdown dropdown-end">
            ...
            <ul tabindex="0" class="p-2 shadow menu dropdown-content bg-base-100 rounded-box w-52">
                <li>
                    <a href="{{ route('MasterStore.profile') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            class="inline-block w-5 h-5 mr-2 stroke-current">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
